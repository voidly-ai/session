...
function isStale(pkgDir: string): boolean {
  const outputs = ["index.mjs", "index.d.ts", "breakEven.mjs", "breakEven.d.ts", "proofs.mjs", "proofs.d.ts", "proofsAuto.mjs", "proofsAuto.d.ts", "proofsCli.mjs", "nodeFiles.mjs", "nodeFiles.d.ts"].map((f) =>
    join(pkgDir, "dist", f),
  );
